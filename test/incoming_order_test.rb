...
class IncomingOrderTest < Minitest::Test
  ...
  def order_has_output
    output = {"milk"=>0, "dark"=>0, "white"=>0, "sugar free"=>0}
  ...
  def test_milk_chocolate_promotion
    output_after_promotion = {"milk"=>8, "dark"=>0, "white"=>0, "sugar free"=>1}
  ...
  def test_different_milk_chocolate_promotion
    output_after_promotion = {"milk"=>7, "dark"=>0, "white"=>0, "sugar free"=>1}
  ...
  def test_white_chocolate_promotion
    output_after_promotion = {"milk"=>0, "dark"=>1, "white"=>5, "sugar free"=>3}
  ...
  def test_dark_chocolate_promotion
    output_after_promotion = {"milk"=>0, "dark"=>3, "white"=>0, "sugar free"=>0}
  ...
  def test_sugar_free_chocolate_promotion
    output_after_promotion = {"milk"=>0, "dark"=>3, "white"=>0, "sugar free"=>5}
  ...
  def test_add_milk_chocolates_increases_appropriate_output_and_available_wrapper_keys
    available_wrappers_and_output_after_adding_chocolates = {"milk"=>1, "dark"=>0, "white"=>0, "sugar free"=>1}
  ...
  def test_add_white_chocolates_increases_appropriate_output_and_available_wrapper_values
    available_wrappers_and_output_after_adding_chocolates = {"milk"=>0, "dark"=>0, "white"=>1, "sugar free"=>1}
  ...
  def test_add_sugar_free_chocolates_increases_appropriate_output_and_available_wrapper_values
    available_wrappers_and_output_after_adding_chocolates = {"milk"=>0, "dark"=>1, "white"=>0, "sugar free"=>1}
    sf_order.add_chocolates('sugar free')
  ...
  def test_add_dark_chocolates_increases_appropriate_output_and_available_wrapper_values
    available_wrappers_and_output_after_adding_chocolates = {"milk"=>0, "dark"=>1, "white"=>0, "sugar free"=>0}
